...
#undef hash_to_challenge_prime_with_pk_j
#undef public_key_finalize
#undef public_key_init

#define hash_to_challenge_prime_with_pk_j               SQISIGN_NAMESPACE(hash_to_challenge_prime_with_pk_j)
...
#undef new_signature_from_bytes
#undef new_signature_to_bytes
...
#define new_signature_from_bytes                        SQISIGN_NAMESPACE(new_signature_from_bytes)
#define new_signature_to_bytes                          SQISIGN_NAMESPACE(new_signature_to_bytes)
...
#undef quat_equivalent_special_norm_ideal
...
#define quat_equivalent_special_norm_ideal              SQISIGN_NAMESPACE_GENERIC(quat_equivalent_special_norm_ideal)
...
#undef new_protocols_sign

#define new_protocols_sign                              SQISIGN_NAMESPACE(new_protocols_sign)
...
#undef new_protocols_verify

#define new_protocols_verify                            SQISIGN_NAMESPACE(new_protocols_verify)
